        ...
        <div className="cards__wrapper">
          <ul className="cards__items">
            <CardItem
              ...
              text="With our app for fitness you can choose and order a service you like and enjoy its benefits for a long time. see what services the training club offers"
              label="Services"
              path="/services"
            />
            <CardItem
          ...
          <ul className="cards__items">
            <CardItem
              ...
              text="Our exercise machines are of the highest quality for fitness. The choice of
          ...
          one of our many cube trainers and ask a question"
            ...
            <CardItem
              ...
              text="Swimming is also included in our fitness program. You can always try your hand at our large swimming pool. There will be a plenty of space for everyone"
              label="Pool"
              path="/services"
            />
            <CardItem
              ...
              text="our club also has a large selection of spa treatments. Often our client comes to relax their body after a hard and strenuous workout in our fitness club.
"
              label="SPA"
              path="/services"
            />
